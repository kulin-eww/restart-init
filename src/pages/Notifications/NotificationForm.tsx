        ...
        <>
            <div className="bg-layout-bg rounded-lg shadow-md px-6 py-4">
                <div className="flex justify-start items-center mb-2 gap-2">
                    ...
                    <div className="text-xl font-bold">Send Broadcast Notification</div>
                </div>
                <hr />
                <div className="w-full mt-4 bg-bg-secondary p-4 rounded-xl">
                    <form onSubmit={formik.handleSubmit} className="w-full bg-bg-secondary p-4 rounded-xl">
                        ...
                        <div className={`border border-gray-300 rounded-[5px] mt-4 grid px-2 pt-2 mb-4 ${formik?.values?.sendTo === "specificUsers" ? "grid-cols-2" : "grid-cols-1"}`}>
                            <FormControl>
                                ...
                                >
                                    ...
                                    <FormControlLabel
                                        ...
                                        checked={
                                            formik?.values.sendTo === "specificUsers" ? true : false
                                        }
                                    ...
                                    <FormControl>
                                        ...
                                        >
                                            ...
                                            <FormControlLabel
                                                ...
                                                label="Vendors"
                                                checked={
                                                    formik?.values.specificUser === "vendor" ? true : false
                                                }
                                            ...
                                            <FormControlLabel
                                                ...
                                                label="Drivers"
                                                checked={
                                                    formik?.values.specificUser === "driver" ? true : false
                                                }
